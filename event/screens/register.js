  ...
  const loadList =()=>{
    ...
    const searchlist = ()=> {
      if (search=='') {
        ...
        || String(item.phone).startsWith(search.toLowerCase()))
        if (newdata != '') {
    ...
    return (
            ...
            {showForm==false?
                ...
                <Text style={styles.formLabel}>Enter your Name or Phone number</Text>
                      <TextInput placeholder='Name or phone number'
